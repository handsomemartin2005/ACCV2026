...
def get_params():
    params = {
        'weight': '../Graph-MDETR/run/train/exp2/weights/best.pt',
        'device': 'cuda:0',
        'method': 'GradCAMPlusPlus', # GradCAMPlusPlus, GradCAM, XGradCAM, EigenCAM, HiResCAM, LayerCAM, RandomCAM, EigenGradCAM
        'layer': [19] ,  # [12, 16, 19]  [4, 5, 6, 7]
        'backward_type': 'all',  # class, box, all
        'conf_threshold': 0.3,  # 0.3  # 相对于YOLOV8，需要设大一点
        'ratio': 0.5,  # 0.02-0.1
        'show_box': False,
        'renormalize': True
    }
...
if __name__ == '__main__':
    ...
    model(r'../Graph-MDETR/images/wjswb.jpg', '/home/yhn/Projects/RTDETR-main/run/heatmap')
    print('End')