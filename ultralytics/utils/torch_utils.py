...
def model_info_for_loggers(trainer):
    ...
    if trainer.args.profile:  # profile ONNX and TensorRT times
        ...
        results = {
            ...
            'model/GFLOPs': 0 if not getattr(trainer.args, 'verbose', True) else round(get_flops(trainer.model), 3)}
...
def strip_optimizer(f: Union[str, Path] = 'best.pt', s: str = '') -> None:
    ...
    # deserialize trusted local Ultralytics checkpoints that contain model args.
