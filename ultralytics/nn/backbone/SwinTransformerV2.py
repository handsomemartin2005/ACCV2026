...
from timm.layers import PatchEmbed, Mlp, DropPath, to_2tuple, trunc_normal_, _assert, ClassifierHead,resample_patch_embed, ndgrid, get_act_layer, LayerType
from timm.models._builder import build_model_with_cfg
from timm.models._features import feature_take_indices
from timm.models._features_fx import register_notrace_function
from timm.models._registry import generate_default_cfgs, register_model, register_model_deprecations

__all__ = ['swinv2_tiny_window16_256']  # model_registry will add each entrypoint fn to this
...
class SwinTransformerV2(nn.Module):
    ...
    def __init__(
            self,
            img_size: _int_or_tuple_2_t = 256,
            patch_size: int = 4,
            in_chans: int = 3,
            num_classes: int = 18,
            global_pool: str = 'avg',
    ...
    def forward_intermediates(
            ...
            output_fmt: str = 'NCHW',
            intermediates_only: bool = True,) -> Union[List[torch.Tensor], Tuple[torch.Tensor, List[torch.Tensor]]]:
...
def _cfg(url='', **kwargs):
    return {
        'url': url,
        'num_classes': 18, 'input_size': (3, 256, 256), 'pool_size': (8, 8),
...
def swinv2_tiny_window16_256(pretrained=False, **kwargs) -> SwinTransformerV2:
    ...
    chs = []
    model = _create_swin_transformer_v2('swinv2_tiny_window16_256', pretrained=pretrained , **dict(model_args, **kwargs))
