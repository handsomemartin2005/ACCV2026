...
if __name__ == '__main__':
    ...
    input = torch.rand([1, 3, 800, 800]).to(device)
    model = fasternet_s(weights=None, cfg='/home/robot/Projects/RTDETR-main/ultralytics/nn/backbone/faster_cfg/fasternet_s.yaml')
