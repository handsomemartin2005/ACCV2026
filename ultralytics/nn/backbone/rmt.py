...
class VisRetNet(nn.Module):
    ...
    def __init__(self, in_chans=3, num_classes=17,
...
if __name__ == '__main__':
    ...
    from get_flops_fuse import fuse
    ...
    inputs = torch.randn((1, 3, 800, 800)).to(device)

    # 计算para和FLOPs
    model.eval()

    macs, params = profile(model.to(device), (inputs,), verbose=False)
