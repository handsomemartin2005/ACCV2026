...
class Exporter:
    ...
    def export_coreml(self, prefix=colorstr('CoreML:')):
        ...
        if self.model.task == 'classify':
            ...
            if self.args.nms:
                LOGGER.warning(f"{prefix} WARNING ⚠️ 'nms=True' is only available for Detect timm_models like 'yolov8n.pt'.")
    ...
    def export_saved_model(self, prefix=colorstr('TensorFlow SavedModel:')):
        ...
        # Remove/rename TFLite timm_models
        if self.args.int8:
    ...
    def _add_tflite_metadata(self, file):
        """Add metadata to *.tflite timm_models per https://www.tensorflow.org/lite/models/convert/metadata."""
    ...
    def _pipeline_coreml(self, model, weights_dir=None, prefix=colorstr('CoreML Pipeline:')):
        ...
        # from coremltools.timm_models.neural_network import flexible_shape_utils
        # s = [] # shapes
        ...
        # 4. Pipeline timm_models together
