...
class yolov8_erf:
    ...
    def process(self):
        ...
        data = data / np.max(data)      #   rescale to [0,1] for the comparability among timm_models
...
def get_params():
    params = {
        'weight': '../Graph-MDETR/run/train/exp/weights/best.pt', # 只需要指定权重即可
        'device': 'cuda:0',
        'layer': '9', # string
        'dataset': '../Graph-MDETR/dataset/coco/images/test',
        'num_images': 50,
        'save_path': '../Graph-MDETR/run/result/12.png'
    }
    return params
