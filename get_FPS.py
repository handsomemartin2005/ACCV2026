...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='../Graph-MDETR/run/train/exp/weights/best.pt', help='trained weights path')
    parser.add_argument('--batch', type=int, default=1, help='total batch size for all GPUs') # 增大会导致FPS变大
    parser.add_argument('--imgs', nargs='+', type=int, default=[224, 224], help='[height, width] image sizes')
    ...
    parser.add_argument('--half', action='store_true', default=False, help='fp16 mode.') # 是否开启半精度，会快些，但不常用.
